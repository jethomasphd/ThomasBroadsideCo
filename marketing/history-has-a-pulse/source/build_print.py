...
page(c,w,h,8);text(c,'THE SHOP / THE SHEET / THE STORY',30,548,7.5,'Mono',RED);title(c,'Words\nto live\nwith.',30,477,64)
...
line(c,45,72,522);text(c,'WORDS TO LIVE WITH',45,49,8,'Mono');text(c,'thomasbroadside.co',429,49,8,'Mono');c.showPage();c.save()
