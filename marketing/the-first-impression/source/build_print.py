...
image(c,K/'artwork/dunlap.png',34,152,364,205)
text(c,'PHILADELPHIA / JULY 4-5, 1776',34,135,7,'Mono',SOFT)
...
for n,ch in enumerate(DATA['chapters'],3):
    ...
    image(c,K/'artwork'/f'{ch["id"]}.png',34,238,364,205)
...
image(c,K/'artwork/dunlap.png',297,147,319,180)
text(c,'DUNLAP’S WORKING NIGHT / RECONSTRUCTED',297,129,6.1,'Mono',SOFT)
...
image(c,K/'artwork/dunlap.png',38,350,344,194);image(c,K/'source/products/declaration-of-independence.jpg',410,350,162,216)
