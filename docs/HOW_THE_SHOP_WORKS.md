...
|---|---|---|
| **Digital** | A file they print at home tonight | $9 |
...
Jacob keeps a set of **computer clerks** — software that reads and
writes. The clerks drafted the website, keep the catalog and the books
tidy, sort the mail, and count the visitors. Think of them as a back
office that never sleeps and never signs anything.

**That last part is the house law.** A clerk can *draft* anything, but
these require a named human being, every single time:

- **Prices** — Jacob sets them.
...
floor. Customers aren't sold any of this — the storefront talks about
paper and ink, and one honest sentence on the Press page says the
information side is kept by machines and signed by humans.
...
never have to answer customer email — the desk exists so you don't.

## David — the gate

Editions are marked **EDITION — NUMBER & INSPECT** in the queue and wait
for you: cotton paper, numbered of 250, embossed mark, your inspection.
Nothing leaves without passing your eye — nothing ever has. A **Hold**
with one honest line beats a shipped sheet you didn't like. The store's
whole promise is that this gate exists.
...
1. **Cited** — every quote carries its source; if we can't cite it, we
   don't print it.
2. **Pre-partisan** — the founding era, not a party.
3. **Printed here** — every physical sheet comes off our press and says
   so.

And **the gate**: by **January 31, 2027**, this store must have taken
**150 orders and $5,000**, or we retire it honestly and keep the shop.
No new designs, no new promises, until it earns its place.
...
| A refund | Jacob only |
| An idea for a new design | Tell Jacob — it goes in the after-the-gate book |
| Anything about the clerks | Ask Jacob straight; there is nothing secret in this building |

*Well done is better than well said — the sheet over the machine means
the store, too.*
