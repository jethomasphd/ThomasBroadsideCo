...
Revised 2026-09-16. See `source/validation.json` for measured media, print and email results.
...
- Actual native browser playback verified: duration 80 seconds, readyState 4, playback advanced; English captions disabled initially. Escape closes, pauses the film, and returns focus to the play button.
- Six original generated clips sampled at 0.2, 3, 6 and 9 seconds, including both new scenes. Finished films sampled at chapter interiors and end cards. All MP4s decode through FFmpeg without errors.
- Narration durations fit their segments with a half-second lead and room at the end. Main film 80 seconds; social films 30/30/15. Stock narrator is Miriam.
- Five reading chapters have five distinct scene identities: sea, hill, soul, rest, wood. The opening room is separate. Website, editable social art, print data and film timeline agree. Regression tests reject shared chapter imagery and detect duplicate source assets. Every narrative moving shot plays once; longer holds use gentle time stretching.
